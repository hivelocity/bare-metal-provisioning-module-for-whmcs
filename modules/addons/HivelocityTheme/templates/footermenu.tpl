                        ...
                        <div style="padding: 20px;">
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-xs-12"> 
                                    <h2>Footer Menu</h2> <hr>
                                    <a href="{$systemurl}?module=HivelocityTheme&page=addfootermenu" class="btn btn--primary" style="float:right;">Add New</a><br>
                                </div>
                                <div class="col-sm-12 col-xs-12"> 
                                            ...
                                            <table width="100%" role="grid" class="lu-table lu-table--mob-collapsible dataTable no-footer dtr-column">  
                                                ...
                                                {foreach from=$footermenus item=v}
                                                    <tr role="row"> 
                                                        ...
                                                        <td>{$v['status']}</td>
                                                        <td><a href="{$systemurl}?module=HivelocityTheme&page=addfootermenu&footerid={$v['id']}&footermenuact=edit" class="btn-sm btn--warning"><i class="fa fa-pencil"></i></a>
                                                        <a onclick="return confirm('Are you sure you want to delete?')" href="{$systemurl}?module=HivelocityTheme&page=footermenu&footerid={$v['id']}&footermenuact=delete" class="btn-sm btn--danger"><i class="fa fa-trash"></i></a>
                                                    </tr>
                                                {/foreach}
                                                </tbody>
                                            </table> 
